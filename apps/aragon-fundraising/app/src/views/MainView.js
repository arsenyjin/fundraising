...
export default () => {
  ...
  useEffect(async () => {
    if (connectedUser) {
      const bondedBalance = await api.call('balanceOf', connectedUser, bondedTokenAddress).toPromise()
      const daiBalance = await api.call('balanceOf', connectedUser, daiAddress).toPromise()
      const antBalance = await api.call('balanceOf', connectedUser, antAddress).toPromise()
